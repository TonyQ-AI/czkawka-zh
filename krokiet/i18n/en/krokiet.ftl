...
similar_images_keep_best = Suggested to keep
similar_images_keep_best_tooltip = Recommended to keep the sharpest photo (highest resolution, then largest file size)
...
rust_delete_confirmation = Are you sure you want to permanently delete the selected items?
rust_delete_confirm_i_understand = I understand this permanently deletes the files
...
scan_button_tooltip = Add folders, then start scanning for duplicates and similar files
stop_button_tooltip = Stop the currently running scan
select_button_tooltip = Select which files to process using predefined rules (e.g. keep the clearest photo)
move_button_tooltip = Move the selected files to a folder you choose
delete_button_tooltip = Permanently delete the selected files (requires an extra confirmation)
trash_button_tooltip = Move the selected files to the recycle bin so they can be restored
save_button_tooltip = Save the list of found files to a file
sort_button_tooltip = Sort the results by a column
rename_button_tooltip = Rename the selected files
...
selection_the_biggest_resolution = Select the clearest (highest resolution)
...
selection_all_except_biggest_resolution = Select all except the clearest (keep highest resolution)
...
clean_button_tooltip = Remove EXIF metadata from the selected files
...
optimize_button_tooltip = Re-encode or crop the selected videos
...
hardlink_button_tooltip = Replace the selected files with hard links to save space
...
softlink_button_tooltip = Replace the selected files with symbolic links
...
compare_button_tooltip = Compare similar images side by side
