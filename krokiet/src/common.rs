...
pub const MAX_STR_DATA_SIMILAR_IMAGES: usize = StrDataSimilarImages::KeepSuggestion as usize + 1;
    ...
    pub(crate) fn get_str_int_sort_idx(self, str_idx: i32) -> SortIdx {
        ...
        match self {
            ...
            Self::SimilarImages => match StrDataSimilarImages::try_from(str_idx as u8).unwrap_or_else(|_| panic!("Invalid str idx {str_idx} for SimilarImages")) {
                StrDataSimilarImages::Name | StrDataSimilarImages::Path | StrDataSimilarImages::KeepSuggestion => SortIdx::StrIdx(str_idx),
