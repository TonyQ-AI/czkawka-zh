...
fn translate_items(app: &MainWindow) {
    ...
    translation.set_scan_button_tooltip(flk!("scan_button_tooltip").into());
    translation.set_stop_button_tooltip(flk!("stop_button_tooltip").into());
    translation.set_select_button_tooltip(flk!("select_button_tooltip").into());
    translation.set_move_button_tooltip(flk!("move_button_tooltip").into());
    translation.set_delete_button_tooltip(flk!("delete_button_tooltip").into());
    translation.set_trash_button_tooltip(flk!("trash_button_tooltip").into());
    translation.set_save_button_tooltip(flk!("save_button_tooltip").into());
    translation.set_sort_button_tooltip(flk!("sort_button_tooltip").into());
    translation.set_rename_button_tooltip(flk!("rename_button_tooltip").into());
    ...
    translation.set_clean_button_tooltip(flk!("clean_button_tooltip").into());
    ...
    translation.set_optimize_button_tooltip(flk!("optimize_button_tooltip").into());
    ...
    translation.set_hardlink_button_tooltip(flk!("hardlink_button_tooltip").into());
    ...
    translation.set_softlink_button_tooltip(flk!("softlink_button_tooltip").into());
    ...
    translation.set_delete_confirm_i_understand(flk!("rust_delete_confirm_i_understand").into());
    ...
    translation.set_compare_button_tooltip(flk!("compare_button_tooltip").into());
    ...
    // "不规范名称" 功能对中文用户不合理，从左侧工具栏隐藏入口。
    let tools_model_filtered: Vec<_> = tools_model
        .into_iter()
        .filter(|(_, tab)| *tab != ActiveTab::BadNames)
        .collect();
    let gui_state = app.global::<GuiState>();
    gui_state.set_tools_model(ModelRc::new(VecModel::from(tools_model_filtered)));
    ...
    settings.set_similar_images_column_name(fnm(&[&selection, &similarity, &size, &dimensions, &file_name, &path, &mod_date, &keep]));
